...
% x0=[10 12];
% fv=[];gv=[];
% options = optimoptions('fminunc','SpecifyObjectiveGradient',true,'Algorithm','quasi-newton','HessUpdate','steepdesc');
% [x,fval,exitflag,output] = fminunc(FF,x0,options)
% plot(fv(:,2),fv(:,3),'b-*')
